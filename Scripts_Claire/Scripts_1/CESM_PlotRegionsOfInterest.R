...
## CESM ##
W.America.Alf<-read.csv("F:/wd/CESM/Alfisol.WAmerica.time.csv")
names(W.America.Alf)
...
W.America.Moll<-read.csv("F:/wd/CESM/Mollisol.wAmerica.time.csv")
...
N.Europe.Spod<-read.csv("F:/wd/CESM/Spodosol.NEurope.time.csv")
...
Amazon.Ox<-read.csv("F:/wd/CESM/Oxisol.Amazon.time.csv")
...
Eurasia.Mol<-read.csv("F:/wd/CESM/Mollisol.Eurasia.time.csv")

par(tck=0.03, mgp=c(3,0.5,0), mar=c(5,5,2,5))
plot(Tas~Time,data=Eurasia.Mol,xlab="Year",ylab=expression(Temperature~change~group("(",degree~C,")")),type="l",lwd=2,main="", col="black", cex.lab=1.6, cex.axis=1.6, ylim=c(-2,8))
lines(Tsl.surf~Time,data=Eurasia.Mol,lwd=2,col="blue")
lines(Tsl.deep~Time,data=Eurasia.Mol,lwd=2,col="red")
legend(x="topleft",legend=c("Air","Soil 0 - 2 cm","Soil 80 - 100 cm"),col=c("black","blue","red"), lwd=2, bty="n",cex=1.4)

plot(mrlsl.surf~Time,data=Eurasia.Mol,xlab="Year",ylab=expression(Soil~moisture~change~group("(",kg~m^{-3},")")),type="l",lwd=2,main="", col="red", cex.lab=1.6, cex.axis=1.6, ylim=c(-40,30))
lines(mrlsl.deep~Time,data=Eurasia.Mol,lwd=2,col="blue")
legend(x="topleft",legend=c("0 - 2 cm","80 - 100 cm"),col=c("blue","red"), lwd=2, bty="n",cex=1.4)

MidEast.Arid<-read.csv("F:/wd/CESM/Aridisol.MidEast.time.csv")

par(tck=0.03, mgp=c(3,0.5,0), mar=c(5,5,2,5))
plot(Tas~Time,data=MidEast.Arid,xlab="Year",ylab=expression(Temperature~change~group("(",degree~C,")")),type="l",lwd=2,main="", col="black", cex.lab=1.6, cex.axis=1.6, ylim=c(-2,8))
lines(Tsl.surf~Time,data=MidEast.Arid,lwd=2,col="blue")
lines(Tsl.deep~Time,data=MidEast.Arid,lwd=2,col="red")
legend(x="topleft",legend=c("Air","Soil 0 - 2 cm","Soil 80 - 100 cm"),col=c("black","blue","red"), lwd=2, bty="n",cex=1.4)

plot(mrlsl.surf~Time,data=MidEast.Arid,xlab="Year",ylab=expression(Soil~moisture~change~group("(",kg~m^{-3},")")),type="l",lwd=2,main="", col="red", cex.lab=1.6, cex.axis=1.6, ylim=c(-40,30))
lines(mrlsl.deep~Time,data=MidEast.Arid,lwd=2,col="blue")
legend(x="topleft",legend=c("0 - 2 cm","80 - 100 cm"),col=c("blue","red"), lwd=2, bty="n",cex=1.4)