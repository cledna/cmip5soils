...
NLAT=(64 64 64 192 128 90 90 145 120 96 128 96 160 96 192)
NLON=(128 128 128 288 256 144 144 192 180 96 256 192 320 144 288)
VARIABLES=("mrlsl")
...
#Select the historical data range, 1986-2005
 cdo seldate,1985-01-0100:00,2005-12-3100:00 ${WD}/${VAR}-historical/${VAR}_${REALM}_${MODEL[i]}_historical_${ENS}_${HISTSTART}-${HISTEND}.nc ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_198601-200512.nc
...
# Global zonal mean
cdo zonmean ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_${EXP2}_Map_2081-2100.nc ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_${EXP2}_latmean_2080-2100_Global.nc
