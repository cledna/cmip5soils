...
TOPZ=(0.007100635 0.007100600 0.05 0.007100635 193 0.010 0.0500 0.050 0.01 0.01785280 0.025 0.03 0.01 0.007100635 )
Z1=(0.00710064 0.0071006 000.05 0.00710064 193 0.01 0.05 0.05 0.01 0.0178528 0.025 000.03 0.01 0.00710064)
Z2=(1.03803 1.03803 02.225 1.03803 194 0.9 0.8271 2 1.05 0.932152 1.5 000.78 1.25 1.03803)
...
NLAT=(64 64 64 192 128 90 90 145 120 128 128 96 160 96)
NLON=(128 128 128 288 256 144 144 192 180 256 256 192 320 144)
...
# cdo seldate,1985-01-0100:00,2005-12-3100:00 ${WD}/${VAR}-historical/${VAR}_${REALM}_${MODEL[i]}_historical_r1i1p1_${HISTSTART}-${HISTEND}.nc ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_198601-200512.nc
...
# if [ $VAR = "tas" ]
# then
	# cdo seltimestep,1 ${WD}/tsl-historical/tsl_Lmon_${MODEL[i]}_historical_${ENS}_${HISTSTART}-${HISTEND}.nc ${WD}/OUT/${MODEL[i]}/${MODEL[i]}_ocean-mask-temp.nc
...
# fi
# rm ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_${EXP2}_200601-210012_anom.nc
# rm ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_${EXP2}_208001-210012.nc
# rm ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_198601-200512.nc
...
# for SO in ${SOIL[@]}; do ## loop over soils
	...
	# cdo enlarge,${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_${EXP2}_200601-210012_anom.nc ${WD}/OUT/${MODEL[i]}/${SO}${MODEL[i]}_norm.nc ${WD}/OUT/${MODEL[i]}/${SO}${MODEL[i]}_norm_enlarged.nc
	# # Multiple enlarged weights grid by timeseries and store weird values as a temp file
	# cdo mul ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_${EXP2}_200601-210012_anom.nc ${WD}/OUT/${MODEL[i]}/${SO}${MODEL[i]}_norm_enlarged.nc ${WD}/OUT/${MODEL[i]}/${VAR}_${MODEL[i]}_${EXP2}_200601-210012_anom_${SO}_ts_temp.nc
...
# cdo sellonlatbox,$ZOLON1,$ZOLON2,$ZOLAT1,$ZOLAT2 ${WD}/OUT/${MODEL[i]}/Mollisol${MODEL[i]}_rect.nc ${WD}/OUT/${MODEL[i]}/${ZO}${MODEL[i]}-boxtemp.nc
...
# End of century monthly means
	# cdo monmean -seldate,2080-01-0100:00,2100-12-3100:00 ${WD}/${VAR}-${EXP2}/${VAR}_${REALM}_${MODEL[i]}_${EXP2}_${ENS}_200601-210012.nc ${WD}/OUT/${MODEL[i]}/${VAR}_${REALM}_${MODEL[i]}_${EXP2}_2080-2100_mon.nc
