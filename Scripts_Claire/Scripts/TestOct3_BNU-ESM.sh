...
TOPZ=(0.007100635 0.007100600 0.05 0.007100635 193 000.01 000.05 000.05 0000.01 0.01785280 00.025 000.03 000.01 0.007100635 ) #top depth in model
Z1=(0.00710064 0.0071006 000.05 0.00710064 193 000.01 000.05 000.05 0000.01 0.0178528 00.025 000.03 000.01 0.00710064)  # layer at ~5 cm depth
Z2=(1.03803 1.03803 02.225 1.03803 194 0000.9 0.8271 000002 001.05 0.932152 0001.5 000.78 001.25 1.03803) # layer at ~ 100 cm depth
ZDIFF=(-1.03092936 -1.0309294 -2.175 -1.03092936 -1 -0.89 -0.7771 -1.95 -1.04 -0.9142992 -1.475 -0.75 -1.24 -1.03092936)
ZDIFF1=(-0.00710064 -0.0071006 -000.05 -0.00710064 -193 -0.01 -0.05 -0.05 -0.01 -0.0178528 -0.025 -000.03 -0.01 -0.00710064) # diff in distance between surface and that layer
ZDIFF2=(-1.03803 -1.03803 -02.225 -1.03803 -194 -0.9 -0.8271 -2 -1.05 -0.932152 -1.5 -000.78 -1.25 -1.03803) # diff in distance between surface and that layer
# diffs used to calculate time of heat transfer to these depth

NLAT=(64 64 64 192 128 90 90 145 120 96 128 96 160 96)  #before regriding
NLON=(128 128 128 288 256 144 144 192 180 96 256 192 320 144) #before regriding
...
XP2=("rcp85") #Loop through the two 21st century experiments. Need to subtract historical from them.
